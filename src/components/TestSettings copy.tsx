		...
		<div className=" bg-gray-100 min-h-screen ">
			...
			<div className="bg-white rounded-lg shadow-md overflow-hidden">
				...
				<div className="p-4 sm:p-6 border-b border-gray-200">
					...
					<div className="relative w-32 rounded-xl border-2 border-yellow-400 p-4 shadow-sm">
						{/* Edit icon */}
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-3">
						{Object.keys(questionTypes).map((type) => (
							<div
								key={type}
								className="border flex-col flex border-gray-300 rounded-md overflow-hidden"
							>
								{/* Header of each question type card */}
								<div className="flex items-center relative justify-between p-2 bg-gray-50">
									<div className="flex items-center">
										<input
											type="checkbox"
									...
									{/* Edit and Lock icons */}
									<div className="position top-1 right-1">
										<GoPencil size={18} />
									</div>
								</div>
								...
								<div className="p-2 bg-white flex items-center">
									<input
										type="number"
										className="w-full border border-gray-300 rounded-md px-2 py-1 text-sm text-gray-800 focus:outline-none"
									...
									/>
									{/* Lock icon next to count input */}
									<div className="w-6 h-6 flex items-center justify-center bg-gray-200 text-gray-600 rounded-full font-bold text-xs ml-2">
										<svg
											xmlns="http://www.w3.org/2000/svg"
											className="h-4 w-4"
											fill="none"
				...
				<div className="p-4 sm:p-6 border-b border-gray-200">
					...
					<div className="flex items-center">
						...
						{/* "N" radius button */}
						<div className="w-6 h-6 flex items-center justify-center bg-blue-500 text-white rounded-full font-bold text-xs ml-2">
							N
						</div>
					</div>
				</div>
